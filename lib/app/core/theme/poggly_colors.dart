...
class PogglyColors extends ThemeExtension<PogglyColors> {
  ...
  @override
  ThemeExtension<PogglyColors> copyWith({
    Color? grayscale100,
    Color? grayscale200,
    Color? grayscale300,
    Color? grayscale400,
  ...
  @override
  ThemeExtension<PogglyColors> lerp(
      covariant ThemeExtension<PogglyColors>? other, double t) {
    if (other is! PogglyColors) {
      return this;
    }
