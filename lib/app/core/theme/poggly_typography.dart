...
class PogglyTypography extends ThemeExtension<PogglyTypography> {
  ...
  @override
  ThemeExtension<PogglyTypography> copyWith({
    Color? defaultColor,
    TextStyle? title,
    TextStyle? header1,
    TextStyle? header2,
  ...
  @override
  ThemeExtension<PogglyTypography> lerp(
      covariant ThemeExtension<PogglyTypography>? other, double t) {
    if (other is! PogglyTypography) {
      return this;
    }
    return PogglyTypography(
